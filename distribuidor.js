...
function ecdv(){
    ...
    case 1:
        res+=(`<br>A camada de valência é: 1s${s1}</div>`) 
        break
    case 2:
    if (p2>0){
        res+=(`<br>A camada de valência é: 2s${s2} 2p${p2}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 2s${s2}</div>`)
    }break
    case 3:
    if (p3>0){
        res+=(`<br>A camada de valência é: 3s${s3} 3p${p3}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 3s${s3}</div>`)
    }break
    case 4:
    if(p4>0) {
        res+=(`<br>A camada de valência é: 4s${s4} 4p${p4}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 4s${s4}</div>`)
    }break
    case 5:
    if(p5>0) {
        res+=(`<br>A camada de valência é: 5s${s5} 5p${p5}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 5s${s5}</div>`)
    }break
    case 6:
    if(p6>0) {
        res+=(`<br>A camada de valência é: 6s${s6} 6p${p6}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 6s${s6}</div>`)
    }break
    case 7:
    if(p7>0) {
        res+=(`<br>A camada de valência é: 7s${s7} 7p${p7}</div>`)
    }else{
        res+=(`<br>A camada de valência é: 7s${s7}</div>`)
    }break
    }
}